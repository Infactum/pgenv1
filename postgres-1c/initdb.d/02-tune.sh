...
gosu postgres sed -i -e"s/^#\?max_connections =.*$/max_connections = 200/" $PGDATA/postgresql.conf
...
gosu postgres sed -i -e"s/^#\?work_mem =.*$/work_mem = 13107kB/" $PGDATA/postgresql.conf
